...
for i in range(0, len(l1)):
    l2.append(0)
    df = pd.read_csv(r'C:\Users\taniska\Downloads\Prototype.csv')
...
np.ravel
# print
# Read a csv named Prototype-1.csv
tr = pd.read_csv(r'C:\Users\taniska\Downloads\Prototype-1.csv')
...
w2 = Label(root, justify=LEFT, text="Made By Taniska " + "AI&DS " + "5 Semester", fg="Pink", bg="Blue")
w2.config(font=("Times", 30, "bold italic"))
